...
const CATEGORIES = ['Todos', 'Energia', 'Movimentação', 'Iluminação', 'Transporte', 'Infraestrutura'];

const CLIENTS = [
  'VOTORANTIM', 'KINROSS', 'NEXA', 'PETROBRAS', 'VALE', 'CEMIG',
  'ANGLOGOLD', 'JAGUAR', 'GERDAU', 'USIMINAS', 'MOSAIC', 'CSN',
];
...
Object.assign(window, { EQUIPMENTS, CATEGORIES, CLIENTS, SECTORS });
